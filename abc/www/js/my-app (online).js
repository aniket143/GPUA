...
myApp.modalPassword('Enter Your Password?', 'Password', 
      function (value) {
        //myApp.alert('Your name is "' + value + '". You clicked Ok button','SBIT');
          ...
          $$.get('chkpass.php', {clientid:clnid,pass:value}, function (data) {
		alert(data);
		if (data == "1")
		{
			if(rewpt=='' && totamt == '' )
  ...
  { 
	 $$.post('http://shopnearn.co.in/mobileapp/insertdetail.php', {memberId:memberId,billno:billno,bill:bill,totamt:totamt,netamt:netamt,t1:t1,reward_pt:reward_pt}, function (data) 
	 {
  $('div#message').html(data);
 		 			 myApp.alert(data);
...
{
myApp.alert("Please Select Any Option First");
}
...
{
myApp.alert("Please Enter Data In Textbox");	
}
